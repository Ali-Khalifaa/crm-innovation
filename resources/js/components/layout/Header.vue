                ...
                <div class="header-element">
                    <div class="horizontal-logo">
                        <a href="#" class="header-logo">
                            <img src="/images/logo.png" alt="CRM Innovation" class="desktop-logo" style="max-height:36px;">
                            <img src="/images/logo.png" alt="CRM" class="toggle-logo" style="max-height:30px;">
                            <img src="/images/logo.png" alt="CRM Innovation" class="desktop-dark" style="max-height:36px;">
                            <img src="/images/logo.png" alt="CRM" class="toggle-dark" style="max-height:30px;">
                            <img src="/images/logo.png" alt="CRM Innovation" class="desktop-white" style="max-height:36px;">
                            <img src="/images/logo.png" alt="CRM" class="toggle-white" style="max-height:30px;">
                        </a>
                    </div>
                </div>
                <!-- End::header-element -->
            ...
            <div class="header-content-right">
                ...
                <div class="header-element">
                    ...
                    <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                        <li><router-link :to="{name: 'dashboard'}" class="dropdown-item d-flex"><i class="ti ti-user-circle fs-18 me-2 op-7"></i>{{$t('global.profile')}}</router-link></li>
