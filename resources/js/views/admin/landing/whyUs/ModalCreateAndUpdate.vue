<template>
    <div class="modal fade" id="why-item-modal" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" v-model="form.title_ar" maxlength="100"
                                :class="{'is-invalid': errors.title_ar}" placeholder="دعم فني متميز">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" v-model="form.title_en" maxlength="100"
                                :class="{'is-invalid': errors.title_en}" placeholder="Premium Support">
                        ...
                        <div class="col-12 d-flex align-items-center">
                            <div class="custom-toggle-switch d-flex align-items-center">
                                <input id="why-item-active" type="checkbox" v-model="form.is_active">
                                <label for="why-item-active" class="label-primary"></label>
...
export default {
    ...
    setup(props, { emit }) {
        ...
        const modalTitle = computed(() => {
            if (props.type === 'create') return 'إضافة عنصر جديد';
            const title = props.dataRow?.title_ar || props.dataRow?.title_en || '';
            return title ? `تعديل العنصر # ${title}` : 'تعديل العنصر';
        });
        ...
        const submit = () => {
            ...
            const url = props.type === 'edit'
                ? `dashboard/landing/why-items/${props.dataRow.id}`
                : 'dashboard/landing/why-items';
