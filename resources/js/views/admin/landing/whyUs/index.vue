<template>
    <div>
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">لماذا تختارنا</h1>
            <div class="ms-md-1 ms-0">
                <nav><ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">لماذا تختارنا</li>
                </ol></nav>
            </div>
        </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" v-model="form.subtitle.ar" maxlength="100"
                                            :class="{'is-invalid': fieldError('subtitle.ar')}" placeholder="لماذا تختارنا">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" v-model="form.subtitle.en" maxlength="100"
                                            :class="{'is-invalid': fieldError('subtitle.en')}" placeholder="Why Choose Us">
                                    ...
                                    <div class="col-12">
                                        <div class="custom-toggle-switch d-flex align-items-center">
                                            <input id="why-section-active" type="checkbox" v-model="form.is_active">
                                            <label for="why-section-active" class="label-primary"></label>
                ...
                <div class="col-12">
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            <h6 class="card-title mb-0"><i class="bx bx-grid-alt me-2"></i>كروت لماذا تختارنا</h6>
                            <button v-if="permission.includes('landing why edit')"
                                @click.prevent="showModelCreate"
                                class="btn btn-sm btn-primary-light">
                                <i class="ri-add-line me-1 fw-semibold align-middle"></i>إضافة عنصر
                            </button>
                        </div>
                        <div class="card-body">
...
export default {
    ...
    setup() {
        ...
        const loadSection = () => adminApi.get('dashboard/landing/why').then(res => {
        ...
        const loadItems = () => adminApi.get('dashboard/landing/why-items').then(res => {
        ...
        const submitSection = () => {
            ...
            adminApi.post('dashboard/landing/why', fd)
                .then(() => {
        ...
        const openItemModal = () => {
            ...
            nextTick(() => {
                nextTick(() => {
                    const el = document.getElementById('why-item-modal');
                    if (!el) return;
        ...
        const deleteItem = (id, index) => {
            Swal.fire({
                ...
                adminApi.delete(`dashboard/landing/why-items/${id}`).then(() => {
