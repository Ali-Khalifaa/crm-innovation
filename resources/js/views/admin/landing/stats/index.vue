                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" v-model="form.subtitle.ar" maxlength="100"
                                            :class="{'is-invalid': fieldError('subtitle.ar')}" placeholder="أرقامنا تتحدث">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" v-model="form.subtitle.en" maxlength="100"
                                            :class="{'is-invalid': fieldError('subtitle.en')}" placeholder="Our Numbers Speak">
                                    ...
                                    <div class="col-12">
                                        <div class="custom-toggle-switch d-flex align-items-center">
                                            <input id="stat-section-active" type="checkbox" v-model="form.is_active">
                                            <label for="stat-section-active" class="label-primary"></label>
                ...
                <div class="col-12">
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            <h6 class="card-title mb-0"><i class="bx bx-bar-chart me-2"></i>كروت الإحصاءات</h6>
                            <button v-if="permission.includes('landing stat edit') && !isStatLimitReached"
                        ...
                        <div class="card-body">
                            <div class="table-responsive mb-2">
                                <table class="table text-nowrap table-striped">
                                    <thead><tr>
                                        <th>#</th><th>القيمة (AR)</th><th>القيمة (EN)</th><th>اللاحقة</th>
                                        <th>التسمية (AR)</th><th>التسمية (EN)</th><th>الصورة</th>
                                    ...
                                    <tbody v-else><tr><td class="text-center" colspan="10">{{ $t('global.NoDataFound') }}</td></tr></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    setup() {
        ...
        const MAX_SHORT = 100;
        const MAX_STAT_ITEMS = 4;

        const isStatLimitReached = computed(() => items.value.length >= MAX_STAT_ITEMS);
        ...
        const loadSection = () => adminApi.get('dashboard/landing/stats').then(res => {
        ...
        const loadItems = () => adminApi.get('dashboard/landing/stat-items').then(res => {
        ...
        const submitSection = () => {
            ...
            adminApi.post('dashboard/landing/stats', fd)
                .then(() => {
        ...
        const showModelCreate = () => {
            if (isStatLimitReached.value) return;
        ...
        const deleteItem = (id, index) => {
            ...
            Swal.fire({
                ...
                adminApi.delete(`dashboard/landing/stat-items/${id}`).then(() => {
        ...
        return {
            ...
            itemType, itemRow, itemModalOpen, isStatLimitReached,
