<template>
    <div>
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">أعضاء الفريق</h1>
            ...
            <div class="col-xl-12">
                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        <h6 class="card-title mb-0">قائمة أعضاء الفريق</h6>
                        <button v-if="permission.includes('landing team create')"
                            @click="showModelCreate" class="btn btn-sm btn-primary-light"
                            data-bs-toggle="modal" data-bs-target="#team-modal">
                            <i class="ri-add-line me-1 fw-semibold align-middle"></i>إضافة عضو
                        </button>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="(item, i) in items" :key="item.id">
                                        ...
                                        <td>
                                            <button v-if="permission.includes('landing team edit')"
                                                class="btn btn-sm btn-warning-light me-1"
                                                data-bs-toggle="modal" data-bs-target="#team-modal"
                                                @click="showModelUpdate(item)">
                                                <i class="ri-edit-line"></i>
                                            </button>
                                            <button v-if="permission.includes('landing team delete')"
