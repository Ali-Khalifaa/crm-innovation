                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" v-model="form.subtitle.ar" maxlength="100"
                                            :class="{'is-invalid': fieldError('subtitle.ar')}" placeholder="كيف يعمل النظام">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" v-model="form.subtitle.en" maxlength="100"
                                            :class="{'is-invalid': fieldError('subtitle.en')}" placeholder="How It Works">
                                    ...
                                    <div class="col-12">
                                        <div class="custom-toggle-switch d-flex align-items-center">
                                            <input id="how-section-active" type="checkbox" v-model="form.is_active">
                                            <label for="how-section-active" class="label-primary"></label>
                ...
                <div class="col-12">
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            <h6 class="card-title mb-0"><i class="bx bx-grid-alt me-2"></i>خطوات كيف يعمل</h6>
...
export default {
    ...
    setup() {
        ...
        const loadSection = () => adminApi.get('dashboard/landing/how-it-works').then(res => {
        ...
        const loadItems = () => adminApi.get('dashboard/landing/how-items').then(res => {
        ...
        const submitSection = () => {
            ...
            adminApi.post('dashboard/landing/how-it-works', fd)
                .then(() => {
        ...
        const deleteItem = (id, index) => {
            Swal.fire({
                ...
                adminApi.delete(`dashboard/landing/how-items/${id}`).then(() => {
