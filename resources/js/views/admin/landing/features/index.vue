<template>
    <div>
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">المميزات</h1>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" v-model="form.subtitle.ar" maxlength="100"
                                            :class="{'is-invalid': fieldError('subtitle.ar')}" placeholder="مميزات النظام">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" v-model="form.subtitle.en" maxlength="100"
                                            :class="{'is-invalid': fieldError('subtitle.en')}" placeholder="System Features">
                                    ...
                                    <div class="col-12">
                                        <div class="custom-toggle-switch d-flex align-items-center">
                                            <input id="feature-section-active" type="checkbox" v-model="form.is_active">
                                            <label for="feature-section-active" class="label-primary"></label>
                ...
                <div class="col-12">
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            <h6 class="card-title mb-0"><i class="bx bx-grid-alt me-2"></i>كروت المميزات</h6>
                            <button v-if="permission.includes('landing feature edit')"
                                @click.prevent="showModelCreate"
                                class="btn btn-sm btn-primary-light">
                                <i class="ri-add-line me-1 fw-semibold align-middle"></i>إضافة ميزة
                            </button>
                        </div>
                        <div class="card-body">
...
export default {
    ...
    setup() {
        ...
        const loadSection = () => adminApi.get('dashboard/landing/features').then(res => {
        ...
        const loadItems = () => adminApi.get('dashboard/landing/feature-items').then(res => {
        ...
        const submitSection = () => {
            ...
            adminApi.post('dashboard/landing/features', fd)
                .then(() => {
        ...
        const openItemModal = () => {
            ...
            nextTick(() => {
                nextTick(() => {
                    const el = document.getElementById('feature-item-modal');
                    if (!el) return;
        ...
        const deleteItem = (id, index) => {
            Swal.fire({
                ...
                adminApi.delete(`dashboard/landing/feature-items/${id}`).then(() => {
