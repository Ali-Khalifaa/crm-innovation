<template>
    <div class="modal fade" id="feature-item-modal" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" v-model="form.title_ar" maxlength="100"
                                :class="{'is-invalid': errors.title_ar}" placeholder="إدارة جهات الاتصال">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" v-model="form.title_en" maxlength="100"
                                :class="{'is-invalid': errors.title_en}" placeholder="Contact Management">
                        ...
                        <div class="col-12 d-flex align-items-center">
                            <div class="custom-toggle-switch d-flex align-items-center">
                                <input id="feature-item-active" type="checkbox" v-model="form.is_active">
                                <label for="feature-item-active" class="label-primary"></label>
...
export default {
    ...
    setup(props, { emit }) {
        ...
        const modalTitle = computed(() => {
            if (props.type === 'create') return 'إضافة ميزة جديدة';
            const title = props.dataRow?.title_ar || props.dataRow?.title_en || '';
            return title ? `تعديل الميزة # ${title}` : 'تعديل الميزة';
        });
        ...
        const submit = () => {
            ...
            const url = props.type === 'edit'
                ? `dashboard/landing/feature-items/${props.dataRow.id}`
                : 'dashboard/landing/feature-items';
