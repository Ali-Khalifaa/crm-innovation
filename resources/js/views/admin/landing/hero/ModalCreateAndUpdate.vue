<template>
    <div class="modal fade" id="hero-slide-modal" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" v-model="form.title_ar" maxlength="100"
                                :class="{'is-invalid': errors.title_ar}" placeholder="لوحة تحكم متكاملة">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" v-model="form.title_en" maxlength="100"
                                :class="{'is-invalid': errors.title_en}" placeholder="Integrated Dashboard">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" v-model="form.subtitle_ar" maxlength="100"
                                :class="{'is-invalid': errors.subtitle_ar}" placeholder="كل بياناتك في مكان واحد">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" v-model="form.subtitle_en" maxlength="100"
                                :class="{'is-invalid': errors.subtitle_en}" placeholder="All your data in one place">
                        ...
                        <div class="col-12 d-flex align-items-center">
                            <div class="custom-toggle-switch d-flex align-items-center">
                                <input id="hero-slide-active" type="checkbox" v-model="form.is_active">
                                <label for="hero-slide-active" class="label-primary"></label>
    ...
    setup(props, { emit }) {
        ...
        const submit = () => {
            ...
            const url = props.type === 'edit'
                ? `dashboard/landing/hero-slides/${props.dataRow.id}`
                : 'dashboard/landing/hero-slides';
