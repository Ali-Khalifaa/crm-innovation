<template>
    <div class="container-fluid">
                        ...
                        <div class="table-responsive mb-2">
                            <table class="table text-nowrap table-striped">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">{{ $t('global.domain') }}</th>
        ...
        <reason v-model="reasonShow" :type="type" :dataRow="dataRow" :model="'App\\Models\\Country'" :url="'countries'" @created="getData(pagePaginate)"/>
    </div>
</template>
