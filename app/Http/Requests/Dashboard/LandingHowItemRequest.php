...
class LandingHowItemRequest extends FormRequest
{
    ...
    {
        $isUpdate = (bool) $this->route('landingHowItem');
        $itemId   = $isUpdate ? $this->route('landingHowItem')->id : null;
        ...
        return [
            ...
            'sort_order'     => [
                ...
                'integer',
                'min:1',
                Rule::unique('landing_how_items', 'sort_order')->ignore($itemId),
            ],
            'is_active' => 'boolean',
        ];
    }
