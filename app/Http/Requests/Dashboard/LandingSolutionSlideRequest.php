...
class LandingSolutionSlideRequest extends FormRequest
{
    ...
    {
        $isUpdate = (bool) $this->route('landingSolutionSlide');
        $slideId  = $isUpdate ? $this->route('landingSolutionSlide')->id : null;
        ...
        return [
            ...
            'sort_order'     => [
                ...
                'integer',
                'min:1',
                Rule::unique('landing_solution_slides', 'sort_order')->ignore($slideId),
            ],
            'is_active' => 'boolean',
        ];
    }
