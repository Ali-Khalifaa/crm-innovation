...
class LandingWhyItemRequest extends FormRequest
{
    ...
    {
        $isUpdate = (bool) $this->route('landingWhyItem');
        $itemId   = $isUpdate ? $this->route('landingWhyItem')->id : null;
        ...
        return [
            ...
            'sort_order'     => [
                ...
                'integer',
                'min:1',
                Rule::unique('landing_why_items', 'sort_order')->ignore($itemId),
            ],
            'is_active' => 'boolean',
        ];
    }
