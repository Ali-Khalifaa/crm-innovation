...
class LandingProblemItemRequest extends FormRequest
{
    ...
    {
        $isUpdate = (bool) $this->route('landingProblemItem');
        $itemId   = $isUpdate ? $this->route('landingProblemItem')->id : null;
        ...
        return [
            ...
            'impact_label_ar'    => 'nullable|string|max:' . self::MAX_SHORT,
            'impact_label_en'    => 'nullable|string|max:' . self::MAX_SHORT,
            'image'              => $isUpdate
            ...
            'sort_order'         => [
                ...
                'integer',
                'min:1',
                Rule::unique('landing_problem_items', 'sort_order')->ignore($itemId),
            ],
            'is_active' => 'boolean',
        ];
    }
